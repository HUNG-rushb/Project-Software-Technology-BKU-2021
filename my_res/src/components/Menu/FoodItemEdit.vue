      ...
      <div class="row gy-5">
        ...
        >
          <div class="card p-3 border bg-light">
            <img
              v-bind:src="require('../../assets/Menu/' + product.food_image)"
              class="card-img-top"
              alt="..."
            />
            <div class="card-body">
              ...
              <button class="btn btn-secondary center" id="update">
                Chỉnh sửa
              </button>
              <!-- </router-link> -->
    ...
    return {
      products: [
        ...
        },
        {
          ...
          food_price: 10000,
          food_type: "drink",
          food_image: "pepsi.jpg",
        },
        {
          food_id: 6,
          food_name: "Cơm dương châu",
          food_price: 120000,
          food_type: "food",
          food_image: "comchien.png",
        },
        {
          food_id: 7,
          food_name: "Hủ tiếu",
        ...
        },
        {
          ...
          food_price: 20000,
          food_type: "drink",
          food_image: "trachanh.jpg",
        },
        {
          food_id: 9,
          food_name: "Nước khoáng",
          food_price: 10000,
          food_type: "drink",
          food_image: "nuockhoang.png",
        },
      ],
    };
  },
